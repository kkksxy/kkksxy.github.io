...
var map = L.map('map')
 ...
 var items = [];
 var airtable_read_endpoint = "https://api.airtable.com/v0/appKIU0zkdHt3AVTL/Venues?api_key=key0vayVDVm0i0ucu";
 var data = [];
...
$(document).ready(function(){
  ...
  $("button#get_data1").click(function() {
      ...
      var airtable_read_endpoint = "https://api.airtable.com/v0/appKIU0zkdHt3AVTL/Roll-up?api_key=key0vayVDVm0i0ucu";
      $.getJSON(airtable_read_endpoint, function(result) {
            $.each(result.records, function(key,value) {
                items = [];
